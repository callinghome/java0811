...
public class PetStore {
    ...
    public static void main(String[] args) {
        ...
        d3.age    =4;
        //dog 印出
        System.out.printf("品種:%s 個數:%d 價格:%,d 年齡:%d 小計:%,7d\n", Dog.type, d1.amount, d1.price, d1.age, d1.amount*d1.price);
        System.out.printf("品種:%s 個數:%d 價格:%,d 年齡:%d 小計:%,7d\n", Dog.type, d2.amount, d2.price, d2.age, d2.amount*d2.price);
        System.out.printf("品種:%s 個數:%d 價格:%,d 年齡:%d 小計:%,7d\n", Dog.type, d3.amount, d3.price, d3.age, d3.amount*d3.price);
